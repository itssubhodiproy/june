...
from app.schemas.table import TableCreate, TableDetailResponse, TableListItem, TableResponse, TableUpdate
...
async def get_table(
    ...
    table_service = TableService(db)
    try:
        return await table_service.get_table(user=current_user, table_id=table_id)
